...
module.exports = {
  ...
  networks: {
    ...
    ganache_local: {
      provider: function() {
        return new HDWalletProvider(process.env.MNEMONIC, "http://127.0.0.1:9545", AccountIndex)
      },
      network_id: 1337
    },
    goerli_infura: {
    ...
    sepolia: {
      provider: () => new HDWalletProvider(process.env.MNEMONIC, `https://sepolia.infura.io/v3/ffa60321cbbd4cfda3352014c556e3c3`, AccountIndex),
      network_id: 11155111,
      confirmations: 2,
      timeoutBlocks: 200,
      skipDryRun: true
